        ...
        <div class="col-lg-6">
          <div class="shop-content">
            <form action="{{ route('transactions.store') }}" method="POST">
              ...
              <div class="mb-3">
                  <label for="Telephone" class="form-label fw-semibold">N° de Téléphone du Bénéficiaire</label>
                  <input type="text"  name="Telephone" id="Telephone" class="form-control" placeholder="Entrez un numéro de téléphone" required>
              </div>
