...
<li class="sidebar-item">
    ...
    <ul aria-expanded="false" class="collapse first-level">
        <li class="sidebar-item">
            <a class="sidebar-link primary-hover-bg" href="{{ route('statistique') }}" aria-expanded="false">
                <iconify-icon icon="mdi:chart-bar" class="fs-6 aside-icon"></iconify-icon>
                <span class="hide-menu ps-1">Statistiques</span>
            </a>
        </li>
        <li class="sidebar-item">
